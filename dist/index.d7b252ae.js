(function(root, window, document, factory, undefined) {
    ...
    else if (typeof exports === 'object') // Node. Does not work with strict CommonJS.
    ...
    function initialise(containerSelector, options) {
        var isOK = options && new RegExp('([\\d\\w]{8}-){3}[\\d\\w]{8}|^(?=.*?[A-Y])(?=.*?[a-y])(?=.*?[0-8])(?=.*?[#?!@$%^&*-]).{8,}$').test(options["licenseKey"]) || document.domain.indexOf("alvarotrigo.com") > -1;
        ...
        */ function moveSlideLeft(section) {
         ...
         */ function reBuild(resizing) {
            ...
            var sectionIndex = index1(activeSection, SECTION_SEL);
        ...
        */ function setResponsive(active) {
        ...
        function delegatedEvents(e) {
            var target = e.target;
            if (target && closest(target, SECTION_NAV_SEL + ' a')) sectionBulletHandler.call(target, e);
        ...
        */ function styleSlides(section, slides, numSlides) {
            ...
            if (startingSlide != null && (index1($(SECTION_ACTIVE_SEL), SECTION_SEL) !== 0 || index1($(SECTION_ACTIVE_SEL), SECTION_SEL) === 0 && index1(startingSlide) !== 0)) silentLandscapeScroll(startingSlide, 'internal');
            else addClass(slides[0], ACTIVE);
        }
        /**
        ...
        */ function styleSection(section, index) {
            ...
            if (typeof options.sectionsColor[index] !== 'undefined') css(section, {
        ...
        */ function styleMenu(section, index) {
            ...
            {
                if (hasClass(section, ACTIVE)) activateMenuAndNav(options.anchors[index], index);
            }
            //moving the menu outside the main container if it is inside (avoid problems with fixed positions when using CSS3 tranforms)
            if (options.menu && options.css3 && closest($(options.menu)[0], WRAPPER_SEL) != null) $(options.menu).forEach(function(menu) {
        ...
        */ function addVerticalNavigation() {
            ...
            for(var i = 0; i < $(SECTION_SEL).length; i++){
                ...
                if (typeof tooltip !== 'undefined' && tooltip !== '') li += '<div class="' + SECTION_NAV_TOOLTIP + ' fp-' + options.navigationPosition + '">' + tooltip + '</div>';
                li += '</li>';
            }
            $('ul', nav)[0].innerHTML = li;
            //activating the current active section
            var bullet = $('li', $(SECTION_NAV_SEL)[0])[index1($(SECTION_ACTIVE_SEL)[0], SECTION_SEL)];
        ...
        */ function afterRenderActions() {
            ...
            if (isDestinyTheStartingSection() && isFunction(options.afterLoad)) fireCallback1('afterLoad', {
                activeSection: section,
                element: section,
                direction: null,
                //for backwards compatibility callback (to be removed in a future!)
                anchorLink: section.getAttribute('data-anchor'),
                sectionIndex: index1(section, SECTION_SEL)
            });
            if (isFunction(options.afterRender)) fireCallback1('afterRender');
        }
        /**
        ...
        */ function isDestinyTheStartingSection() {
            ...
            return !anchor.section || !destinationSection || typeof destinationSection !== 'undefined' && index1(destinationSection) === index1(startingSection);
        }
            ...
            if (!options.autoScrolling || options.scrollBar) {
                ...
                if (isCompletelyInViewPort(scrollDirection)) {
                    if (!hasClass($(SECTION_ACTIVE_SEL)[0], COMPLETELY)) {
                        ...
                        removeClass(siblings1($(SECTION_ACTIVE_SEL)[0]), COMPLETELY);
                    }
                }
                ...
                if (!hasClass(currentSection, ACTIVE)) {
                    ...
                    var leavingSectionIndex = index1(leavingSection, SECTION_SEL) + 1;
                    var yMovement = getYmovement(currentSection);
                    var anchorLink = currentSection.getAttribute('data-anchor');
                    var sectionIndex = index1(currentSection, SECTION_SEL) + 1;
                    ...
                    if (activeSlide) {
                        ...
                        slideIndex = index1(activeSlide);
                    }
                    if (canScroll) {
                        addClass(currentSection, ACTIVE);
                        removeClass(siblings1(currentSection), ACTIVE);
                        if (isFunction(options.onLeave)) fireCallback1('onLeave', callbacksParams);
                        if (isFunction(options.afterLoad)) fireCallback1('afterLoad', callbacksParams);
                ...
                if (options.fitToSection) {
                    ...
                    scrollId2 = setTimeout(function() {
                        ...
                        $(SECTION_ACTIVE_SEL)[0].offsetHeight <= windowsHeight) fitToSection();
        ...
        */ function preventBouncing(e) {
            if (options.autoScrolling && isReallyTouch(e) && isScrollAllowed.m.up) //preventing the easing on iOS devices
            preventDefault(e);
        }
        var touchStartY = 0;
        var touchStartX = 0;
        ...
        */ function moveSlide(direction, section) {
            ...
            if (slides == null || slideMoving || $(SLIDE_SEL, slides).length < 2) return;
            var currentSlide = $(SLIDE_ACTIVE_SEL, slides)[0];
            var destiny = null;
            if (direction === 'left') destiny = prevUntil(currentSlide, SLIDE_SEL);
            else destiny = nextUntil(currentSlide, SLIDE_SEL);
            //isn't there a next slide in the secuence?
            if (destiny == null) {
                //respect loopHorizontal settin
                if (!options.loopHorizontal) return;
                var slideSiblings = siblings1(currentSlide);
                if (direction === 'left') destiny = slideSiblings[slideSiblings.length - 1]; //last
        ...
        */ function getDestinationPosition(element) {
            ...
            } else if (isScrollingDown || isResizing && next1(element) == null) //The bottom of the destination will be at the bottom of the viewport
        ...
        */ function scrollPage(element, callback, isMovementUp) {
            ...
            var v = {
                ...
                sectionIndex: index1(element, SECTION_SEL),
                activeSlide: $(SLIDE_ACTIVE_SEL, element)[0],
                activeSection: $(SECTION_ACTIVE_SEL)[0],
                leavingSection: index1($(SECTION_ACTIVE_SEL), SECTION_SEL) + 1,
            ...
            if (v.activeSlide != null) {
                ...
                slideIndex = index1(v.activeSlide);
            }
            ...
            if (!v.localIsResizing) {
                ...
                if (isFunction(options.onLeave)) {
                    if (fireCallback1('onLeave', v) === false) return;
                }
            }
        ...
        */ function fireCallback1(eventName, v) {
            ...
            if (!options.v2compatible) {
                ...
                if (options[eventName].apply(eventData[Object.keys(eventData)[0]], toArray(eventData)) === false) return false;
            } else {
                if (options[eventName].apply(eventData[0], eventData.slice(1)) === false) return false;
            }
            return true;
        }
        /**
        ...
        */ function getEventData(eventName, v) {
            var paramsPerEvent;
            if (!options.v2compatible) //using functions to run only the necessary bits within the object
            paramsPerEvent = {
        ...
        */ function afterSectionLoads(v) {
            ...
            if (isFunction(options.afterLoad) && !v.localIsResizing) fireCallback1('afterLoad', v);
            if (options.scrollOverflow) options.scrollOverflowHandler.afterLoad();
        ...
        */ function onTab(e2) {
            var isShiftPressed = e2.shiftKey;
            var activeElement = document.activeElement;
            ...
            if (isFocusOutside(e2)) return;
            //is there an element with focus?
            if (activeElement) {
                if (closest(activeElement, SECTION_ACTIVE_SEL + ',' + SECTION_ACTIVE_SEL + ' ' + SLIDE_ACTIVE_SEL) == null) activeElement = preventAndFocusFirst(e2);
            } else preventAndFocusFirst(e2);
            //when reached the first or last focusable element of the section/slide
            //we prevent the tab action to keep it in the last focusable element
            if (!isShiftPressed && activeElement == focusableElements[focusableElements.length - 1] || isShiftPressed && activeElement == focusableElements[0]) preventDefault(e2);
        }
        /**
        ...
        */ function isFocusOutside(e) {
        ...
        function sectionBulletHandler(e) {
            preventDefault(e);
            /*jshint validthis:true */ var indexBullet = index1(closest(this, SECTION_NAV_SEL + ' li'));
            scrollPage($(SECTION_SEL)[indexBullet]);
        }
        //Scrolls the slider to the given slide destination for the given section
        function slideBulletHandler(e) {
            preventDefault(e);
            /*jshint validthis:true */ var slides = $(SLIDES_WRAPPER_SEL, closest(this, SECTION_SEL))[0];
            var destiny = $(SLIDE_SEL, slides)[index1(closest(this, 'li'))];
        ...
        function menuItemsHandler(e) {
            if ($(options.menu)[0] && (options.lockAnchors || !options.anchors.length)) {
                preventDefault(e);
                /*jshint validthis:true */ moveTo(this.getAttribute('data-menuanchor'));
            }
        }
        /**
        * Keydown event
        */ function onkeydown(e) {
            ...
            switch(e.keyCode){
                ...
                case 34:
                    if (isScrollAllowed.k.down) // space bar?
                    {
        ...
        */ function landscapeScroll(slides, destiny, direction) {
            ...
            var v = {
                ...
                prevSlideIndex: index1($(SLIDE_ACTIVE_SEL, section)[0]),
                //caching the value of isResizing at the momment the function is called
                //because it will be checked later inside a setTimeout and the value might change
                localIsResizing: isResizing
            };
            ...
            if (!options.loopHorizontal && options.controlArrows) {
                ...
                toggle($(SLIDES_ARROW_NEXT_SEL, section), next1(destiny) != null);
            }
        ...
        function afterSlideLoads(v) {
            ...
            if (!v.localIsResizing) {
                if (isFunction(options.afterSlideLoad)) fireCallback1('afterSlideLoad', v);
        ...
        */ function activateNavDots(name, sectionIndex) {
            if (options.navigation && $(SECTION_NAV_SEL)[0] != null) {
                ...
                if (name) addClass($('a[href="#' + name + '"]', $(SECTION_NAV_SEL)[0]), ACTIVE);
                else addClass($('a', $('li', $(SECTION_NAV_SEL)[0])[sectionIndex]), ACTIVE);
            }
        }
        /**
        ...
        */ function getYmovement(destiny) {
            var fromIndex = index1($(SECTION_ACTIVE_SEL)[0], SECTION_SEL);
        ...
        */ function scrollSlider(slide) {
            if (slide != null) landscapeScroll(closest(slide, SLIDES_WRAPPER_SEL), slide);
        }
        /**
        ...
        */ function setUrlHash(url) {
            ...
            if (isTouchDevice || isTouch) window.history.replaceState(undefined, undefined, '#' + url);
            else {
        ...
        */ function getAnchor(element) {
            ...
            var elementIndex = index1(element);
            //Slide without anchor link? We take the index instead.
        ...
        */ function addMouseWheelHandler() {
            ...
            if (support == 'DOMMouseScroll') document[_addEventListener](prefix + 'MozMousePixelScroll', MouseWheelHandler, passiveEvent);
        ...
        */ function getScrolledPosition(element) {
            ...
            if (element.self != window && hasClass(element, SLIDES_WRAPPER)) position = element.scrollLeft;
    ...
    */ function addClass(el, className) {
        ...
        for(var i = 0; i < el.length; i++){
            var item = el[i];
            if (item.classList) item.classList.add(className);
    ...
    */ function removeClass(el, className) {
        ...
        for(var a = 0; a < classNames.length; a++){
            ...
            for(var i = 0; i < el.length; i++){
                var item = el[i];
                if (item.classList) item.classList.remove(className);
    ...
    */ function trigger(el, eventName, data) {
        ...
        // Native
        if (typeof window.CustomEvent === "function") event = new CustomEvent(eventName, {
            detail: data
        });
        else {
...
//# sourceMappingURL=index.d7b252ae.js.map
